...
\tagline{Data Scientist and Machine Learning Engineer}
\photo{3cm}{myfoto}
\personalinfo{%
...
Aspiring Data Scientist and Machine Learning Engineer. I am incredibly passionate about Data Science and Machine Learning.

\cvsection{Work Experience}

\cvevent{Data Scientist and Software Engineer}{Pez.AI}{August 2017 -- Present}{Mandaluyong City, Philippines}
\begin{itemize}
\item Training and Implementing Sentiment, Named Entity, and Document Similarity models
\item Creating custom Chatbots for various customers
\item Implementing Client Facing Analytic Dashboards
\item Creating ETL Pipelines for chat data
\item Developing and deploying different Backend Services
\end{itemize}
